      ...
      >
        {!isRegistered && (
          <Typography variant="h2">
            Instant hassle-free Covid Insurance Cover at your doorstep.
          </Typography>
        )}
        {isRegistered && !isPayingPremiun && (
          <Typography variant="h2">
            Once you start paying the premiums you'll recieve a
            payout based on the plan opted and scanned covid documents.
          </Typography>
        )}
        {isPayingPremiun && (
